...
const sampleProjects: Project[] = [
  ...
  },
  {
    ...
    title: "城市垃圾分类调研",
    summary: "走访五个社区，记录垃圾分类实施情况并提出适老化宣传与社区治理建议。",
    description:
      "## 项目背景\n\n上海市垃圾分类政策实施以来效果如何？我们团队深入 5 个社区开展调研。\n\n## 调研方法\n\n- 问卷调查：发放 500 份问卷\n- 实地观察：记录分类投放准确率\n- 访谈：采访社区工作者和居民\n\n## 主要发现\n\n1. 分类准确率平均达到 78%\n2. 老年人群体的分类意识有待加强\n3. 社区督导员制度效果显著",
    coverImage: "/images/huanbao-cover.jpg",
    category: "社区治理",
    outcomeTypes: ["调研报告", "公众号"],
    college: "公共卫生学院",
    recommended: false,
    tags: ["环保", "调研", "城市治理"],
    members: [
      { name: "赵六", role: "项目负责人", avatar: "", link: "" },
    ],
    links: [],
    stats: { views: 0, linkClicks: {} },
  ...
  },
  {
    id: "2024-keji-nongye",
    title: "智慧农业科技助农",
    summary: "将物联网环境监测与精准灌溉技术带进大棚，用低成本方案服务农业生产。",
    description:
      "## 项目概述\n\n利用物联网技术实现智慧农业。团队开发了一套低成本大棚环境监测系统。\n\n## 技术方案\n\n- **硬件**: ESP32 + 土壤湿度传感器 + DHT22 温湿度\n- **后端**: Node.js 数据采集服务\n- **前端**: 可视化仪表盘\n\n## 成果\n\n- 节水 30%\n- 产量提升 15%\n- 获得校级优秀实践项目",
    coverImage: "",
    category: "科技公益",
    outcomeTypes: ["网站", "调研报告"],
    college: "未来技术学院",
    recommended: true,
    tags: ["科技", "农业", "物联网"],
    members: [
      { name: "孙七", role: "技术负责人", avatar: "", link: "" },
